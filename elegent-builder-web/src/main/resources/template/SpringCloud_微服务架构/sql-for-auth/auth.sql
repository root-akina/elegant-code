...
<#assign menu_no = 1003>
<#list base.schemas as db>
(${id},'10000${menu_no?c}000000','100001000000000','${db.name}','c','${db.name}','${db.name}','0',8,'user','2023-05-26 16:46:54','2023-06-17 19:14:38','${db.name}',NULL,1),
<#assign id = id+1 >

<#assign seq = 100>
<#list db.tables as t>
(${id},'10000${menu_no?c}${seq}000','10000${menu_no?c}000000','${t.comment}','m','${t.name}','${t.name}','0',0,'form','2023-05-27 16:46:54','2023-05-27 16:46:54','${t.comment}',NULL,NULL),
<#assign id = id+1 >
<#assign seq = seq+1 >
</#list>
<#assign menu_no = menu_no+1 >
</#list>
(36,'100001002001000','100001000000000','日志管理','c','日志管理','log','0',0,'form','2023-05-27 16:46:54','2023-05-27 16:46:54','日志管理',NULL,NULL);
