...
/**
 * @ClassName dataSecurityLineInnerInterceptor.java
...
public class DataSecurityLineInnerInterceptor extends JsqlParserSupport implements InnerInterceptor {

    private DataSecurityLineHandler dataSecurityLineHandler;
    ...
    protected void appendSelectItem(List<SelectItem> selectItems) {
        ...
        selectItems.add(new SelectExpressionItem(new Column(dataSecurityLineHandler.getDataSecurityColumn())));
    }
    ...
    protected void processPlainSelect(PlainSelect plainSelect) {
        ...
        if (fromItem instanceof Table) {
            ...
            if (dataSecurityLineHandler.isInterceptTable(fromTable.getName())) {
                //#1186 github
    ...
    protected Expression builderExpression(Expression currentExpression, Table table) {
        ...
        inExpression.setRightItemsList(dataSecurityLineHandler.getDataSecurityList());
    ...
    protected Column getAliasColumn(Table table) {
        ...
        column.append(dataSecurityLineHandler.getDataSecurityColumn());
    ...
    public void setProperties(Properties properties) {
        PropertyMapper.newInstance(properties)
                .whenNotBlack("dataSecurityLineHandler", ClassUtils::newInstance, this::setDataSecurityLineHandler);
    }
}
